...
#define FOREGROUND_STAR_IMAGE_NAME @"详情2_07"
#define BACKGROUND_STAR_IMAGE_NAME @"详情2_09"
...
- (UIView *)createStarViewWithImage:(NSString *)imageName {
    ...
    CGFloat w = (self.bounds.size.width-self.numberOfStars*10-10)/self.numberOfStars;
    CGFloat H = (self.bounds.size.height-w)/2;
    for (NSInteger i = 0; i < self.numberOfStars; i ++)
    {
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:imageName]];
        imageView.frame = CGRectMake(10+i * (w+10), H, w,w);
